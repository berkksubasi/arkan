  ...
  const services = {
    marka: [
      ...
      },
      {
        ...
        price: "800 TL'den başlayan fiyatlar",
        duration: "2-4 ay",
        icon: ClockIcon,
        popular: false,
      ...
      },
      {
        ...
        price: "2.500 TL'den başlayan fiyatlar",
        duration: "3-8 ay",
        icon: ScaleIcon,
        popular: false,
    ...
    iso: [
      {
        ...
        price: "8.000 TL'den başlayan fiyatlar",
        duration: "3-6 ay",
      ...
      },
      {
        ...
        price: "10.000 TL'den başlayan fiyatlar",
        duration: "4-7 ay",
        icon: HeartIcon,
        popular: false,
      ...
      },
      {
        ...
        price: "12.000 TL'den başlayan fiyatlar",
        duration: "4-8 ay",
        icon: ShieldCheckIcon,
        popular: false,
    ...
    tse: [
      {
        ...
        price: "5.000 TL'den başlayan fiyatlar",
        duration: "2-4 ay",
        icon: CogIcon,
        popular: true,
      ...
      },
      {
        ...
        price: "3.000 TL'den başlayan fiyatlar",
        duration: "1-3 ay",
    ...
    uluslararasi: [
      {
        ...
        price: "3.500 TL'den başlayan fiyatlar",
        duration: "12-18 ay",
        icon: GlobeAltIcon,
        popular: true,
      ...
      },
      {
        ...
        price: "2.800 TL'den başlayan fiyatlar",
        duration: "8-12 ay",
        icon: StarIcon,
        popular: false,
